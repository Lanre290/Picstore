...
<body class="w-screen h-screen flex flex-col justify-center items-center">
    <form action="{{ route('api/auth/sign-up') }}" method="POST" id="sign-up-form" class="w-full md:w-4/6 lg:w-5/12 h-screen flex flex-col items-center justify-center" onsubmit="validateSignUp()">
        @csrf
